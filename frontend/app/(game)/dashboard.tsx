    ...
    >
      ...
      <Pressable testID="daily-card-open" onPress={() => router.push("/daily")} style={styles.dailyCard}>
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
          ...
          <MonoText style={{ color: COLORS.amber, fontSize: 10 }}>VIEW ALL →</MonoText>
        </View>
...
const styles = StyleSheet.create({
  ...
  missionMeta: { flexDirection: "row", gap: 14, marginTop: 10 },
  quickGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginBottom: 14 },
  quickBtn: {
    width: "23%", backgroundColor: COLORS.surface, borderWidth: 1, borderColor: "rgba(0,240,255,0.15)",
    paddingVertical: 12, alignItems: "center", justifyContent: "center",
  },
  quickLabel: { color: COLORS.textPrimary, fontSize: 10, marginTop: 4 },
  dailyCard: { backgroundColor: COLORS.surface, borderWidth: 1, borderColor: "rgba(255,176,0,0.25)", padding: 14 },
  dailyRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 8 },
  miniBarBg: { height: 4, backgroundColor: "rgba(255,255,255,0.08)", marginTop: 4, overflow: "hidden" },
